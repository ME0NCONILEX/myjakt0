...
public enum OrderStatus {
    PENDING("Pending", "The hunter started the checkout process but did not complete it.", 1),
    AWAITING_PAYMENT("Awaiting Payment", "The hunter has completed the checkout process, but payment has yet to be confirmed.", 2),
    AWAITING_FULFILLMENT("Awaiting Fulfillment", "The hunter has completed the checkout process and payment has been confirmed.", 3),
